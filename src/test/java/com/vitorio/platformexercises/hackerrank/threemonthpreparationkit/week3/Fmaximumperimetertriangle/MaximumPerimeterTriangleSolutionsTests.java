...
public class MaximumPerimeterTriangleSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week3/Fmaximumperimetertriangle/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = MaximumPerimeterTriangleSolution.main(inputContent);

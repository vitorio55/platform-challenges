package com.vitorio.platformexercises.hackerrank.threemonthpreparationkit.week1.Gsparsearrays;

import com.vitorio.platformexercises.hackerrank.threemonthpreparationkit.week1.Gsparserarrays.SparseArraysSolution;
...
public class SparseArraysSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week1/Gsparsearrays/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = SparseArraysSolution.main(inputContent);

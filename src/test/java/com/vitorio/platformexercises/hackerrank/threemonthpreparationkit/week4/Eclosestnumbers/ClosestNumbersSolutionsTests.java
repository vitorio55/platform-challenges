...
public class ClosestNumbersSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week4/Eclosestnumbers/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = ClosestNumbersSolution.main(inputContent);

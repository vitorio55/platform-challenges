...
public class CounterGameSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week6/Gcountergame/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = CounterGameSolution.main(inputContent);

...
public class SeparateTheNumbersSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week4/Dseparatethenumbers/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = SeparateTheNumbersSolution.main(inputContent);

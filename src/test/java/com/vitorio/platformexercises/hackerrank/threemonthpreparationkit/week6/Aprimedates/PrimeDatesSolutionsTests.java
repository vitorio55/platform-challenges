...
public class PrimeDatesSolutionsTests {

    private static final String BASE_PATH = "/platformexercises/hackerrank/threemonthpreparationkit/week6/Aprimedates/";
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        int result = PrimeDatesSolution.main(inputContent);

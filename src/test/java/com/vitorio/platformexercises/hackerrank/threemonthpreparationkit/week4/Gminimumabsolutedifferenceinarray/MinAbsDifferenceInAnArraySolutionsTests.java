package com.vitorio.platformexercises.hackerrank.threemonthpreparationkit.week4.Gminimumabsolutedifferenceinarray;

import com.vitorio.platformexercises.hackerrank.threemonthpreparationkit.week4.Gminimumabsolutedifferenceinanarray.MinAbsDifferenceInAnArraySolution;
...
public class MinAbsDifferenceInAnArraySolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week4/Gminimumabsolutedifferenceinanarray/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = MinAbsDifferenceInAnArraySolution.main(inputContent);

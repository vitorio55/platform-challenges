...
public class RecursiveDigitSumSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week6/Frecursivedigitsum/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = RecursiveDigitSumSolution.main(inputContent);

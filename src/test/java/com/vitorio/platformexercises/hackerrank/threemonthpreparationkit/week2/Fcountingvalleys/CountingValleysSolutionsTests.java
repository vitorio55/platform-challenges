package com.vitorio.platformexercises.hackerrank.threemonthpreparationkit.week2.Fcountingvalleys;

import com.vitorio.platformexercises.hackerrank.threemonthpreparationkit.week2.Fcoutingvalleys.CountingValleysSolution;
...
public class CountingValleysSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week2/Fcountingvalleys/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = CountingValleysSolution.main(inputContent);

...
public class TowerBreakersSolutionsTests {
    ...
    void setUp() {
        fileReader = new InputOutputFileReader(
            "/platformexercises/hackerrank/threemonthpreparationkit/week4/Ftowerbreakers/"
        );
    }
    ...
    void testSolution(String input, String output) throws IOException {
        ...
        // When
        String actual = TowerBreakersSolution.main(inputContent);
    ...
    @ParameterizedTest
    @MethodSource("inputsOutputsSource")
    void testSolution_Short(String input, String output) throws IOException {
        // Given
        File inputContent = fileReader.fileFromFilePath(input);
        String[] outputContent = fileReader.readFileContent(output);
        StringBuilder expected = new StringBuilder();
        ...
        // When
        String actual = TowerBreakersShortSolution.main(inputContent);
